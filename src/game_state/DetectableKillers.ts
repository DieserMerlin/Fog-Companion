import { Killer } from "@diesermerlin/fog-companion-web";
...
export const DetectableKillers: KillerDetection[] = [
  ...
  },
  {
    ...
    detect: {
      names: ["THE TWINS"],
      confirmPowerLabel: ["CHARGE POUNCE"],
      powerLabel: ["UNBIND VICTOR", "CONTROL CHARLOTTE"]
    }
  },
  {
    name: Killer.TRICKSTER,
    detect: {
      names: ["THE TRICKSTER"],
  ...
  },
  {
    ...
    detect: {
      ...
      powerLabel: ["BIRDS OF TORMENT"],
      confirmPowerLabel: ["LAUNCH"]
    }
  },
  {
    name: Killer.ONRYO,
  ...
  {
    name: Killer.DARK_LORD,
    detect: {
      names: ["THE DARK LORD", "TRUE FORM"],
      confirmPowerLabel: ["CHARGE POUNCE"],
      powerLabel: ["SHAPESHIFT", "CHARGE HELLFIRE"]
    }
  },
  {
    name: Killer.HOUNDMASTER,
    detect: {
